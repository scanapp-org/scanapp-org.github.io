...
docReady(function() {
    ...
    var qrboxFunction = function(viewfinderWidth, viewfinderHeight) {
        ...
        var minWidthThreshold = 250;
        var minHeightThreshold = 150;
        var edgeSizePercentage = 0.9;

        var minEdgeSize = (viewfinderWidth > viewfinderHeight) ?
            viewfinderHeight : viewfinderWidth;
        var qrboxWidth = Math.floor(minEdgeSize * edgeSizePercentage);
        let qrboxHeight = minval(Math.floor(qrboxWidth / 2), minHeightThreshold);
